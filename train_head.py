        ...
        for i, (inputs, targets) in enumerate(bl):
            ...
            if(val and i % eval_every_n_batches == 0):
                ...
                with torch.no_grad():
                    ...
                    for pred, gt in zip(all_val_preds, all_val_gt):
                    ...
                    if(use_wandb):
                        ...
                        _wandb_log(metrics=val_wandb_metrics, step_metric="step", step=i)
            ...
            if(use_wandb):
                _wandb_log(metrics=metrics, step_metric="step", step=i)
